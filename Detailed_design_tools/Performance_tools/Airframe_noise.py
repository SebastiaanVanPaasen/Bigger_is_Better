...
plt.plot(freq, SPL_gear,"m-.",label = "Main gear")
plt.plot(freq, SPL_nose,"orange",label = "Nose gear")
...
plt.plot(freq, SPL_gear_cor,"m-.",label = "Main gear")
plt.plot(freq, SPL_nose_cor,"orange",label = "Nose gear")
