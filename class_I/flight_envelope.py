...
def construct_envelope():
    ...
    v_pos, n_pos, v_neg, n_neg, gust_speeds = manoeuvring_envelope(1828542.22, 12000, 1.8, 222.99, 221.28)
    v_gust_pos, n_gust_pos, v_gust_neg, n_gust_neg = gust_envelope(1828542.22, 12000, 3.8, 222.99, 8, 221.28,
                                                                   gust_speeds)
    # print(v_neg, n_neg)
