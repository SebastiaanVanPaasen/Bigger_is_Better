...
manoeuvring_loads = manoevring_envelope(masses[0]*g_0, h_cruise, CL_Cruise_max, CL_Cruise_max * 0.8, S, V_cruise)
gust_loads = gust_envelope(masses[0]*g_0, h_cruise, CL_alpha, S, mg_chord, V_cruise, manoeuvring_loads[4])
