...
w_engine = 2270  # kg   Obtained from Bram
propeller_choice = 0

W_e_frac_input = 0.53  # Based on average between wide and narrow body, from Ed Obert
...
M_cruise = 0.84  # Mach number decided to cruise on
