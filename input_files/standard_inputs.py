...
reserve_range = 250 * cc.nm_to_km * 1000  # m     domestic flights of ADSEE-I L3
...
descent_2 = 0.99
landing = 0.992
fuel_fractions_input = [start, taxi, t_o, climb_1, descent_1, climb_2, 
                        descent_2, landing]
...
mass_frac_fix = 0.118
mass_fractions_input = [mass_frac_wing, mass_frac_emp, mass_frac_fuse, 
