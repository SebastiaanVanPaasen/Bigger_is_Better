...
from class_I.drag_estimation import Wing_wetted_area, H_tail_wetted_area, V_tail_wetted_area, Fus_wetted_area, \
    Zero_Lift_Drag_est
from class_I.empennage_for_scissor import class_I_empennage
...
def main_iterator(CL_cruise_input, CD_cruise_input, W_e_frac_input, fuel_fractions_input, mass_fractions_input, N_pas_below):   
    ...
    while i < maximum and percentage > 0.0005:
        ...
        X_LE_root, cg_locations, tail_h, tail_v, x_lemac, avl_h, avl_v, V_h_norm = class_I_empennage(mass_fractions, mac, l_fuselage,
                                                                                x_engines,
        ...
        l_h, c_root_h, c_tip_h, b_h, S_h, x_le_h, sweep_LE_h, MAC_h, y_MAC_h = tail_h[0], tail_h[1], tail_h[2], tail_h[3], tail_h[4], tail_h[5], tail_h[6], tail_h[7], tail_h[8]
        l_v, c_root_v, c_tip_v, b_v, S_v, x_le_v, sweep_LE_v, MAC_v, y_MAC_v = tail_v[0], tail_v[1], tail_v[2], tail_v[3], tail_v[4], tail_v[5], tail_v[6], tail_v[7], tail_v[8]
    ...
    return(y_MAC_h, y_MAC_v, MAC_h, MAC_v, taper, c_root, X_LE_root, b_v, QC_sweep, mass_fractions, lg_weight, cg_locations, x_lemac, mac, fuselage_design, W_TO, V_h_norm, 
           HC_sweep, HC_sweep_h,b, S, l_h, x_le_h, sweep_LE_v, sweep_LE_h, x_le_v, b_v)

#main_iterator(CL_cruise, CD_cruise, W_e_frac)
...
#print(Ct0)
#print(Wcr)
#SAR(Velocity, h, AR, Surface, eff, cd_0, Ct0, Wcr)
# final_diagram(CD_0, Oswald)
