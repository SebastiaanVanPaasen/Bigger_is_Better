...
W = weights["W_TO"] #- weights["W_F"]#1801946.31#1510125.47#1549762.26#1806203.58
...
#    print(Liftdistributionvalues[0])
    ...
    return "maxMz=",maxMz, "maxMy=",maxMy,"minMy", minMy, "maxT=",maxT, "maxFy=",maxFy, "minFz=",minFz, "maxFz",maxFz
