...
y_MAC_h, y_MAC_v, MAC_h, MAC_v, taper, c_root, X_LE_root, b_v, QC_sweep, mass_fractions, lg_weight, cg_locations, x_lemac, MAC, fuselage_design, W_TO, V_h_norm, HC_sweep, HC_sweep_h, b, S, l_h, x_le_h, sweep_LE_v, sweep_LE_h, x_le_v, b_v = main_iterator(CL_cruise, CD_cruise, W_e_frac, M_cruise)
