...
y_MAC_h, y_MAC_v, MAC_h, MAC_v, taper, c_root, X_LE_root, b_v, QC_sweep, mass_fractions, lg_weight, cg_locations, x_lemac, MAC, fuselage_design, W_TO, V_h_norm, HC_sweep, HC_sweep_h, b, S, l_h, x_le_h, sweep_LE_v, sweep_LE_h, x_le_v, b_v = main_iterator(
    CL_cruise, CD_cruise, W_e_frac, M_cruise)
...
xcg_fusegroup, xcg_winggroup, xcg_OEW_MAC, min_cg, max_cg, X_LEMAC_range, W_cargo, min_cg_range = potato(x_le_h,
                                                                                                         sweep_LE_h,
                                                                                                         y_MAC_h, MAC_h,
                                                                                                         x_le_v,
                                                                                                         sweep_LE_v,
...
stability_lessmargin_list, stability_list = Sh_S_stability(x_cg, M_h_cruise, eta, HC_sweep_h, HC_sweep, A, A_h,
                                                           M_cruise, fuselage_design[1], b, S,
                                                           l_h, QC_sweep, m_tv, V_h_norm, b_n_1, b_n_2, b_n_3, b_n_4,
                                                           l_n_1, l_n_2, l_n_3, l_n_4, x_ac_wing,
...
control_list = Sh_S_control(CL_H, C_L_Ah_landing, l_h, V_h_norm, x_cg, Cm_0, A, QC_sweep,
                            ...
                            fuselage_design[1], fuselage_design[1], fuselage_design[7], S, S_netfus, HC_sweep,
                            M_w_landing, eta, CL_0)

opt_X_LEMAC, opt_Sh_S = control_stability_plot(x_cg, min_cg, max_cg, X_LEMAC_range, control_list, stability_list)

print(opt_X_LEMAC, opt_Sh_S)
